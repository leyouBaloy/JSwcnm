<template>
  <div>
    <div id="events-log">
      <h3>Events</h3>
      <div v-for="(event, index) in events" :key="index" style="white-space: pre-wrap;">{{ event }}<hr></div>
    </div>
    <Calendar
      id="calendar"
      :year="currentYear"
...
<script>
import Calendar from "../utils/v-year-calendar.js";
